...
public class Task7 implements Task {
  ...
  private Set<String> vacancyNames(Collection<Company> companies) {
    // Для каждой компании обращаюсь к сету Vacancies,
    // получаю название и вывожу уникальные значения в сет
    // (distinct излишний, так при формировании set-а добавляются уникальные значения).
